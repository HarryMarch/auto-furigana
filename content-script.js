(function () {
    ...
    const WHITE_LISTED_KANJI = new Set(['学校', '学生', '先生', '勉強', '日本', '英語', '国語', '数学', '大学', '留学', '友達', '友達', '名前', '外国', '男子', '女子', '大人', '子供', '会社', '社員', '今日', '明日', '昨日', '毎日', '毎週', '今週', '来週', '午前', '午後', '時間', '日本', '東京', '学校', '駅前', '空港', '病院', '銀行', '郵便', '公園', '本屋', '食事', '飲物', '牛肉', '豚肉', '鳥肉', '野菜', '果物', '水道', '料理', '朝食', '勉強', '運動', '旅行', '電話', '買物', '散歩', '仕事', '結婚', '休憩', '練習', '元気', '有名', '簡単', '大切', '上手', '下手', '便利', '不便', '電車', '自動', '車道', '空港', '道路', '交通', '乗車', '下車', '運転', '駐車', '天気', '電気', '人気', '元日', '毎年', '来年', '去年', '部屋', '家事', '住所', '電話', '写真', '映画', '音楽', '雑誌', '新聞', '地図', '問題', '意味', '研究', '試験', '宿題', '授業', '卒業', '入学', '退学', '就職', '転職', '失業',
        ...
        '場合', '綺麗', '高校', '一番', '家族', '基本', '秘密', '動画', '会話', '相手', '紹介', '重要', '失敗', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']);
